...
<html lang="en">
    ...
    <body data-spy="scroll" data-target="#template-navbar">
                    ...
                    <div class="row dis-table">
                        ...
                        <div class="col-xs-12 col-sm-6 dis-table-cell">
                            <div class="section-content">
                                ...
                                Main Goal of this project is to develop a fully automated restaurant management system which is clear 3D menu, view menu according to their favorite and food will be ready by the time they arrive at the destination. It supports resurgent employees, Managers, and customers
                                </p>
                                <p class="section-content-para">
                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="section-header">
                                        ...
                                        <ul id="filter-list" class="clearfix">
                                            ...
                                            <li class="filter" data-filter=".burger">Burger</li>
                ...
                <div class="container">
                    <div class="row">  
                        <div class="col-md-10 col-md-offset-1">
                            ...
                            <li class="item dessert">
                                    <a href="#">
                                        <img src="{{ asset('images/dessert1.jpg') }}" class="img-responsive" alt="Food" >
                                        <div class="menu-desc text-center">
                                            <span>
                                                <h3>Coffee Shake</h3>
                                             Justin Cleaning by Justin Younger
                                            </span>
                                        </div>
                                    </a>
                                    <h2 class="white">৳220</h2>
                                ...
                                <li class="item dessert">
                                    <a href="#">
                                        <img src="{{ asset('images/dessert2.jpg') }}" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Milk Biscuit</h3>
                                ...
                                <li class="item dessert ">
                                    ...
                                    <a href="#">
                                        <img src="{{ asset('images/dessert3.jpg') }}" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Americana Pizza</h3>
                                                Tomato Sauce, Chicken Sausages
                                            </span>
                                        </div>
                                    </a>
                                ...
                                <li class="item burger">
                                    <a href="#">
                                        <img src="{{ asset('images/burger1.jpg') }}" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                    ...
                                    <h2 class="white">৳340</h2>
                                </li>
                                
                                <li class="item burger">
                                    <a href="#">
                                        <img src="{{ asset('images/burger2.jpg') }}" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                    ...
                                    <h2 class="white">৳240</h2>
                                </li>

                                <li class="item burger">
                                    <a href="#">
                                        <img src="{{ asset('images/burger3.jpg') }}" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                ...
                                <li class="item pizza">
                                    <a href="#">
                                        <img src="{{ asset('images/pizza1.jpg') }}" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Americana Pizza</h3>
                                                Tomato Sauce, Chicken Sausages
                                ...
                                <li class="item pizza">
                                    <a href="#">
                                        <img src="{{ asset('images/pizza2.jpg') }}" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Cheesy Pepperoni Pizza</h3>
                                                Tomato Sauce, Pepperoni, Mozzarella Cheese, Swiss cheese
                                            </span>
                                        </div>
                                    </a>
                                ...
                                <li class="item pizza">
                                    <a href="#">
                                        <img src="{{ asset('images/pizza3.jpg') }}" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Beef Cheese Burge</h3>
                                                Tempor incididunt ut labore et dolore
                                            </span>
                                        </div>
                                    </a>
                                ...
                                <li class="item chinese">
                                    <a href="#">
                                        <img src="{{ asset('images/chinese1.jpg') }}" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Set Menu - 1</h3>
                                                Fried Rice, 2 Pcs Chicken, Vegetable
                                            </span>
                                        </div>
                                    </a>
                                ...
                                <li class="item chinese">
                                    <a href="#">
                                        <img src="{{ asset('images/chinese2.jpg') }}" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Beef Cheese Burge</h3>
                                                Tempor incididunt ut labore et dolore
                                ...
                                <li class="item chinese">
                                    <a href="#">
                                        <img src="{{ asset('images/chinese3.jpg') }}" class="img-responsive" alt="Food" >
                                        <div class="menu-desc">
                                            <span>
                                                <h3>Beef Cheese Burge</h3>
                                                Tempor incididunt ut labore et dolore
        ...
        <section id="great-place-to-enjoy" class="great-place-to-enjoy">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{ asset('images/icons/beer_black.png') }}">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
        ...
        <section id="breakfast" class="breakfast">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{ asset('images/icons/bread_black.png') }}">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
        ...
        <section id="bread" class="bread">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{ asset('images/icons/bread_color.png') }}">
            <div class="container-fluid">
                <div class="row dis-table">
        ...
        <section id="featured-dish" class="featured-dish">
            <img class="img-responsive section-icon hidden-sm hidden-xs" src="{{ asset('images/icons/food_black.png') }}">
            <div class="wrapper">
                <div class="container-fluid">
                    <div class="row dis-table">
                        <div class="col-xs-6 col-sm-6 dis-table-cell color-bg">
